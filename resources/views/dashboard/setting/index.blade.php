        ...
        <section id="update-welcome-video">
            ...
            <div class="bg-white p-4 rounded-md shadow">
                <form onsubmit="submitwelcomevideo(event)">
                    <div class="mb-4">
                        <label for="welcome_video" class="block font-medium text-gray-700">Video Selamat Datang (Copy URL Youtube)</label>
                        ...
                        <input type="text"
                            ...
                            name="welcome_video" id="welcome_video" value="{{ $settings->welcome_video }}">
                    </div>
...
@push('scripts')
    <script>
        ...
        async function submitwelcomevideo(event) {
            ...
            formData.append('welcome_video', welcomeVideoInput.value);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    welcomeVideoInput.value = response.data.path; // Update the input value with the new video URL
