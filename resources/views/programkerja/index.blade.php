...
@section('content')
    <main class="min-h-screen p-8 bg-gray-50">
        ...
        <section class="flex gap-4 shadow bg-white p-4">
            <aside>
                <h3 class="font-semibold text-lg">{{ $programkerja->name }}</h3>
                @php
                    $image =
                        [
                            'KSATRIA BAIK' => '/images/program-kerja/ksatria-baik.jpeg',
                            'KSATRIA RESIK' => '/images/program-kerja/ksatria-resik.jpeg',
                            'KSATRIA RELIGI' => '/images/program-kerja/ksatria-religi.jpeg',
                        ][$programkerja->name] ?? '/images/hero.png';
                @endphp
                <img class="w-64 mt-2 scale-100 hover:scale-125 duration-500" src="{{ $image }}" alt="{{ $programkerja->name }}">
            </aside>
            <aside class="grow">
